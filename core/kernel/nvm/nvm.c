...
switch (opcode) {
    case 0x00: return handle_halt(proc);
    case 0x01: return handle_nop(proc);
    case 0x02: return handle_push(proc);
    case 0x04: return handle_pop(proc);
    case 0x05: return handle_dup(proc);
    case 0x06: return handle_swap(proc);
    case 0x10: return handle_add(proc);
    case 0x11: return handle_sub(proc);
    case 0x12: return handle_mul(proc);
    case 0x13: return handle_div(proc);
    case 0x14: return handle_mod(proc);
    case 0x20: return handle_cmp(proc);
    case 0x21: return handle_eq(proc);
    case 0x22: return handle_neq(proc);
    case 0x23: return handle_gt(proc);
    case 0x24: return handle_lt(proc);
    case 0x30: return handle_jmp(proc);
    case 0x31: return handle_jz(proc);
    case 0x32: return handle_jnz(proc);
    case 0x33: return handle_call(proc);
    case 0x34: return handle_ret(proc);
    case 0x35: return handle_enter(proc);
    case 0x36: return handle_leave(proc);
    case 0x37: return handle_load_arg(proc);
    case 0x38: return handle_store_arg(proc);
    case 0x40: return handle_load(proc);
    case 0x41: return handle_store(proc);
    case 0x42: return handle_load_rel(proc);
    case 0x43: return handle_store_rel(proc);
    case 0x44: return handle_load_abs(proc);
    case 0x45: return handle_store_abs(proc);
    case 0x50: return handle_syscall(proc);
    case 0x51: return handle_break(proc);
    default: return true;
}
