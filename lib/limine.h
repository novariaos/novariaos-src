...
#define LIMINE_TERMINAL_REQUEST_ID { LIMINE_COMMON_MAGIC, 0xc8acd4e3fe9a4843, 0x0ef88d791f3b0293 }

struct limine_terminal_response {
    uint64_t revision;
    uint32_t terminal_count;
    LIMINE_PTR(struct limine_terminal **) terminals;
    LIMINE_PTR(void (*write)(LIMINE_PTR(struct limine_terminal *) terminal, const char *string, uint64_t length));
};
